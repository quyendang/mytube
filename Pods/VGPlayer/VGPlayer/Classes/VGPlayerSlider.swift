...
open class AAA: UISlider {
    ...
    override open func trackRect(forBounds bounds: CGRect) -> CGRect {
        ...
        print(rect)
        let newRect = CGRect(origin: rect.origin, size: CGSize(width: rect.size.width, height: 50.0))
    ...
    func configureSlider() {
        ...
        //self.minimumTrackTintColor = UIColor(hex: "#BF382A")
        self.minimumTrackTintColor = UIColor(hex: "#992b23")
        self.maximumTrackTintColor = UIColor(hex: "#BF382A")
